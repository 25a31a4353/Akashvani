...
export const indiaDeepLinks: Record<string, IndiaLocation> = {
  ...
  puri: { ...andhraPradeshDefault, id: "DIST-OD-PUR", name: "Puri", displayName: "Puri, Odisha, India", category: "District", latitude: 19.8135, longitude: 85.8312, population: 1698730, populationSource: "Census of India 2011 / geoBoundaries ADM2", boundingBox: [19.45, 85.10, 20.25, 86.40], boundary: null, address: { state: "Odisha", district: "Puri" }, source: "geoBoundaries ADM2 / Census 2011 reference district" },
  ...Object.fromEntries(
