...
const sensitivity: GeoCollection = { type: "FeatureCollection", features: [
  { type: "Feature", properties: { id: "seismic-himalayan", screeningName: "DERIVED SEISMIC SCREENING", hazard: "Earthquake sensitivity", level: "High", inputs: "BIS IS 1893:2016 Zone IV/V boundaries + Himalayan tectonic front", method: "Regional macro-tectonic screening envelope; not an observed rupture footprint.", resolution: "Macro-regional", provenance: "DERIVED", timestamp: "2026-09-01", source: "ResQ derived tectonic-belt screening extent; official regulatory reference BIS IS 1893:2016." }, geometry: { type: "Polygon", coordinates: [[[73, 31], [77, 36.8], [95, 36.8], [98, 30], [94, 27], [85, 27.5], [79, 29], [73, 31]]] } },
  { type: "Feature", properties: { id: "seismic-kutch", screeningName: "DERIVED SEISMIC SCREENING", hazard: "Earthquake sensitivity", level: "Moderate", inputs: "BIS IS 1893:2016 Zone V Kutch fault cluster", method: "Intraplate tectonic screening envelope; not an active fault rupture.", resolution: "Macro-regional", provenance: "DERIVED", timestamp: "2026-09-01", source: "ResQ derived tectonic-belt screening extent; not an official seismic-zone boundary." }, geometry: { type: "Polygon", coordinates: [[[68.2, 22.2], [73.6, 22.2], [73.6, 25.4], [68.2, 25.4], [68.2, 22.2]]] } },
  { type: "Feature", properties: { id: "landslide-himalaya", screeningName: "DERIVED LANDSLIDE SCREENING", hazard: "Landslide sensitivity", level: "High", inputs: "ISRO/GSI National Landslide Atlas 2023 (147 susceptible districts) + Copernicus DEM slope", method: "Topographic relief and documented macro-susceptibility intersection; not a live landslide inventory.", resolution: "District macro-zonation", provenance: "DERIVED", timestamp: "2026-09-01", source: "ISRO Landslide Atlas regional coverage context (Himalayas); ResQ screening extent, not a landslide inventory polygon." }, geometry: { type: "Polygon", coordinates: [[[73, 28], [77, 36.8], [96, 36.8], [97, 28.2], [91, 26.5], [83, 27.4], [77, 27.2], [73, 28]]] } },
  { type: "Feature", properties: { id: "landslide-western-ghats", screeningName: "DERIVED LANDSLIDE SCREENING", hazard: "Landslide sensitivity", level: "Moderate", inputs: "ISRO National Landslide Atlas 2023 Western Ghats ranking + Copernicus DEM", method: "Escarpment slope screening (>15° gradient); not a live event polygon.", resolution: "District macro-zonation", provenance: "DERIVED", timestamp: "2026-09-01", source: "ISRO Landslide Atlas regional coverage context; ResQ screening extent, not a landslide inventory polygon." }, geometry: { type: "Polygon", coordinates: [[[73.2, 8.2], [77.4, 8.2], [77.4, 20.8], [74.3, 21.5], [73.2, 8.2]]] } },
  { type: "Feature", properties: { id: "flood-ganga-brahmaputra", screeningName: "DERIVED FLOOD SCREENING", hazard: "Flood sensitivity", level: "High", inputs: "CWC river gauge network + NRSC Bhuvan multi-year flood atlas + Copernicus DEM lowlands (<15m)", method: "River basin floodplain screening envelope (<15m gradient); not a live inundation forecast.", resolution: "Basin floodplain envelope", provenance: "DERIVED", timestamp: "2026-09-01", source: "ResQ broad riverine/monsoon screening extent informed by CWC & Bhuvan; not a live inundation or official flood forecast." }, geometry: { type: "Polygon", coordinates: [[[74, 23.2], [89, 23.2], [97.5, 25.2], [97, 28.8], [88, 29.8], [80, 28.8], [74, 26.2], [74, 23.2]]] } },
  { type: "Feature", properties: { id: "flood-coastal", screeningName: "DERIVED COASTAL SCREENING", hazard: "Flood sensitivity", level: "Moderate", inputs: "IMD Cyclone track buffer + NCCR shoreline change atlas + Copernicus DEM lowlands (<10m MSL)", method: "10km coastal elevation buffer; not an active storm surge warning.", resolution: "Coastal elevation corridor", provenance: "DERIVED", timestamp: "2026-09-01", source: "ResQ broad coastal/monsoon screening extent informed by IMD & NCCR; not a live inundation or official flood forecast." }, geometry: { type: "Polygon", coordinates: [[[72, 8], [76.8, 8], [76.8, 23.5], [72, 23.5], [72, 8]]] } },
] };
